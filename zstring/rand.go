...
func RandUint32Max(max uint32) uint32 { _ = "STUB: not implemented"; return 0 }
...
func Rand(n int, tpl ...string) string { _ = "STUB: not implemented"; return "" }
...
func UniqueID(n int) string { _ = "STUB: not implemented"; return "" }
...
func SecureRandInt(min, max int) (int, error) { _ = "STUB: not implemented"; return 0, nil }
...
// ignore negative weights, can never be picked
...
func (w *Weighteder) Pick() interface{} { _ = "STUB: not implemented"; return nil }
...
func (w *Weighteder) weightedSearch() int { _ = "STUB: not implemented"; return 0 }
...
func getMask(alphabetSize int) byte { _ = "STUB: not implemented"; return 0 }
