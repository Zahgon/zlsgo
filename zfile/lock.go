...
func NewFileLock(path string) *FileLock { _ = "STUB: not implemented"; return nil }
...
func (l *FileLock) Lock() error { _ = "STUB: not implemented"; return nil }
...
func (l *FileLock) Clean() error { _ = "STUB: not implemented"; return nil }
