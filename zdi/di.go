...
func New(parent ...Injector) Injector { _ = "STUB: not implemented"; return *new(Injector) }
...
func (inj *injector) SetParent(parent Injector) { _ = "STUB: not implemented"; return }
...
func WithInterface(ifacePtr Pointer) Option { _ = "STUB: not implemented"; return *new(Option) }
...
func ifeOf(value interface{}) reflect.Type { _ = "STUB: not implemented"; return *new(reflect.Type) }
