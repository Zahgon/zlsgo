...
func DecimalToAny(value, base int) (newNumStr string) { _ = "STUB: not implemented"; return "" }

// AnyToDecimal Convert arbitrary decimal values to decimal
func AnyToDecimal(value string, base int) (v int) { _ = "STUB: not implemented"; return 0 }

func findKey(in string) int { _ = "STUB: not implemented"; return 0 }
